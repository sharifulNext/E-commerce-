...
const PlaceOrder = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            console.log(error);
            toast.error(error.message || "Error while placing order.");
        }
    };
            ...
            <div className="mt-8 w-full lg:max-w-[500px]">
                ...
                <div className="mt-12">
                    ...
                    <div className="w-full text-end mt-8">
                        <button type="submit" className="bg-black text-white px-16 py-3 text-sm active:bg-gray-700 transition-all">PLACE ORDER</button>
                    </div>
                </div>
            </div>
        </form>
